...
#define EE_AUDIO_CLK_TDMIN_A_CTL      0x0080
#define EE_AUDIO_CLK_TDMIN_B_CTL      0x0084
#define EE_AUDIO_CLK_TDMIN_C_CTL      0x0088
#define EE_AUDIO_CLK_TDMIN_LB_CTL     0x008c
...
#define EE_AUDIO_TDMIN_A_CTRL           (0xc0 << 2)
#define EE_AUDIO_TDMIN_B_CTRL           (0xd0 << 2)
#define EE_AUDIO_TDMIN_C_CTRL           (0xe0 << 2)
