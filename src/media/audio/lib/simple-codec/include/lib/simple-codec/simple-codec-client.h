...
class SimpleCodecClient {
 public:
  // Convineance methods not part of the audio codec protocol.
  ...
  bool IsDaiFormatSupported(const DaiFormat& format, std::vector<DaiSupportedFormats>& supported);
 ...
 private:
  ...
  bool IsDaiFormatSupported(const DaiFormat& format, DaiSupportedFormats& supported);
